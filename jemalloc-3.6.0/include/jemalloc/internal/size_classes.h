...
#if (LG_TINY_MIN == 3 && LG_QUANTUM == 3 && LG_PAGE == 17)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	8,	8)					\
    ...
    SIZE_CLASS(45,	8192,	49152)					\
    SIZE_CLASS(46,	8192,	57344)					\
    SIZE_CLASS(47,	8192,	65536)					\
    SIZE_CLASS(48,	16384,	81920)					\
    SIZE_CLASS(49,	16384,	98304)					\
    SIZE_CLASS(50,	16384,	114688)					\

#define	NBINS		51
#define	SMALL_MAXCLASS	114688
#endif

#if (LG_TINY_MIN == 3 && LG_QUANTUM == 3 && LG_PAGE == 18)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	8,	8)					\
    ...
    SIZE_CLASS(49,	16384,	98304)					\
    SIZE_CLASS(50,	16384,	114688)					\
    SIZE_CLASS(51,	16384,	131072)					\
    SIZE_CLASS(52,	32768,	163840)					\
    SIZE_CLASS(53,	32768,	196608)					\
    SIZE_CLASS(54,	32768,	229376)					\

#define	NBINS		55
#define	SMALL_MAXCLASS	229376
#endif

#if (LG_TINY_MIN == 3 && LG_QUANTUM == 3 && LG_PAGE == 19)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	8,	8)					\
    ...
    SIZE_CLASS(53,	32768,	196608)					\
    SIZE_CLASS(54,	32768,	229376)					\
    SIZE_CLASS(55,	32768,	262144)					\
    SIZE_CLASS(56,	65536,	327680)					\
    SIZE_CLASS(57,	65536,	393216)					\
    SIZE_CLASS(58,	65536,	458752)					\

#define	NBINS		59
#define	SMALL_MAXCLASS	458752
#endif

#if (LG_TINY_MIN == 3 && LG_QUANTUM == 3 && LG_PAGE == 20)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	8,	8)					\
    ...
    SIZE_CLASS(57,	65536,	393216)					\
    SIZE_CLASS(58,	65536,	458752)					\
    SIZE_CLASS(59,	65536,	524288)					\
    SIZE_CLASS(60,	131072,	655360)					\
    SIZE_CLASS(61,	131072,	786432)					\
    SIZE_CLASS(62,	131072,	917504)					\

#define	NBINS		63
#define	SMALL_MAXCLASS	917504
#endif
...
#if (LG_TINY_MIN == 3 && LG_QUANTUM == 4 && LG_PAGE == 17)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	8,	8)					\
    ...
    SIZE_CLASS(42,	8192,	49152)					\
    SIZE_CLASS(43,	8192,	57344)					\
    SIZE_CLASS(44,	8192,	65536)					\
    SIZE_CLASS(45,	16384,	81920)					\
    SIZE_CLASS(46,	16384,	98304)					\
    SIZE_CLASS(47,	16384,	114688)					\

#define	NBINS		48
#define	SMALL_MAXCLASS	114688
#endif

#if (LG_TINY_MIN == 3 && LG_QUANTUM == 4 && LG_PAGE == 18)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	8,	8)					\
    ...
    SIZE_CLASS(46,	16384,	98304)					\
    SIZE_CLASS(47,	16384,	114688)					\
    SIZE_CLASS(48,	16384,	131072)					\
    SIZE_CLASS(49,	32768,	163840)					\
    SIZE_CLASS(50,	32768,	196608)					\
    SIZE_CLASS(51,	32768,	229376)					\

#define	NBINS		52
#define	SMALL_MAXCLASS	229376
#endif

#if (LG_TINY_MIN == 3 && LG_QUANTUM == 4 && LG_PAGE == 19)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	8,	8)					\
    ...
    SIZE_CLASS(50,	32768,	196608)					\
    SIZE_CLASS(51,	32768,	229376)					\
    SIZE_CLASS(52,	32768,	262144)					\
    SIZE_CLASS(53,	65536,	327680)					\
    SIZE_CLASS(54,	65536,	393216)					\
    SIZE_CLASS(55,	65536,	458752)					\

#define	NBINS		56
#define	SMALL_MAXCLASS	458752
#endif

#if (LG_TINY_MIN == 3 && LG_QUANTUM == 4 && LG_PAGE == 20)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	8,	8)					\
    ...
    SIZE_CLASS(54,	65536,	393216)					\
    SIZE_CLASS(55,	65536,	458752)					\
    SIZE_CLASS(56,	65536,	524288)					\
    SIZE_CLASS(57,	131072,	655360)					\
    SIZE_CLASS(58,	131072,	786432)					\
    SIZE_CLASS(59,	131072,	917504)					\
...
#if (LG_TINY_MIN == 4 && LG_QUANTUM == 4 && LG_PAGE == 17)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	16,	16)					\
    ...
    SIZE_CLASS(41,	8192,	49152)					\
    SIZE_CLASS(42,	8192,	57344)					\
    SIZE_CLASS(43,	8192,	65536)					\
    SIZE_CLASS(44,	16384,	81920)					\
    SIZE_CLASS(45,	16384,	98304)					\
    SIZE_CLASS(46,	16384,	114688)					\

#define	NBINS		47
#define	SMALL_MAXCLASS	114688
#endif

#if (LG_TINY_MIN == 4 && LG_QUANTUM == 4 && LG_PAGE == 18)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	16,	16)					\
    ...
    SIZE_CLASS(45,	16384,	98304)					\
    SIZE_CLASS(46,	16384,	114688)					\
    SIZE_CLASS(47,	16384,	131072)					\
    SIZE_CLASS(48,	32768,	163840)					\
    SIZE_CLASS(49,	32768,	196608)					\
    SIZE_CLASS(50,	32768,	229376)					\

#define	NBINS		51
#define	SMALL_MAXCLASS	229376
#endif

#if (LG_TINY_MIN == 4 && LG_QUANTUM == 4 && LG_PAGE == 19)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	16,	16)					\
    ...
    SIZE_CLASS(49,	32768,	196608)					\
    SIZE_CLASS(50,	32768,	229376)					\
    SIZE_CLASS(51,	32768,	262144)					\
    SIZE_CLASS(52,	65536,	327680)					\
    SIZE_CLASS(53,	65536,	393216)					\
    SIZE_CLASS(54,	65536,	458752)					\

#define	NBINS		55
#define	SMALL_MAXCLASS	458752
#endif

#if (LG_TINY_MIN == 4 && LG_QUANTUM == 4 && LG_PAGE == 20)
#define	SIZE_CLASSES_DEFINED
/*  SIZE_CLASS(bin,	delta,	sz) */
#define	SIZE_CLASSES							\
    SIZE_CLASS(0,	16,	16)					\
    ...
    SIZE_CLASS(53,	65536,	393216)					\
    SIZE_CLASS(54,	65536,	458752)					\
    SIZE_CLASS(55,	65536,	524288)					\
    SIZE_CLASS(56,	131072,	655360)					\
    SIZE_CLASS(57,	131072,	786432)					\
    SIZE_CLASS(58,	131072,	917504)					\
